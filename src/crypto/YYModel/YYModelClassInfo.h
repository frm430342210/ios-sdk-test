 ...
 */
typedef NS_OPTIONS(NSUInteger, YYModelEncodingType) {
...
@property (nonatomic, assign, readonly) YYModelEncodingType type;    ///< Ivar's type
...
@property (nonatomic, assign, readonly) YYModelEncodingType type;      ///< property's type
