...
static force_inline BOOL YYEncodingTypeIsCNumber(YYModelEncodingType type) {
...
@interface _YYModelPropertyMeta : NSObject {
    ...
    YYModelEncodingType _type;        ///< property's type
    ...
    YYModelClassPropertyInfo *_info;  ///< property's info
    _YYModelPropertyMeta *_next; ///< next meta if there are multiple properties mapped to the same key.
}
@end

@implementation _YYModelPropertyMeta
+ (instancetype)metaWithClassInfo:(YYModelClassInfo *)classInfo propertyInfo:(YYModelClassPropertyInfo *)propertyInfo generic:(Class)generic {
...
- (instancetype)initWithClass:(Class)cls {
    YYModelClassInfo *classInfo = [YYModelClassInfo classInfoWithClass:cls];
    ...
    YYModelClassInfo *curClassInfo = classInfo;
    while (curClassInfo && curClassInfo.superCls != nil) { // recursive parse super class, but ignore root class (NSObject/NSProxy)
        for (YYModelClassPropertyInfo *propertyInfo in curClassInfo.propertyInfos.allValues) {
...
@implementation NSObject (YYModelClass)
...
- (id)yy_modelInitWithCoder:(NSCoder *)aDecoder {
    ...
    for (_YYModelPropertyMeta *propertyMeta in modelMeta->_allPropertyMetas) {
        ...
        if (propertyMeta->_isCNumber) {
            ...
            YYModelEncodingType type = propertyMeta->_type & YYEncodingTypeMask;
            switch (type) {
                case YYEncodingTypeObject: {
