...
typedef GPB_ENUM(ChainMessageType) {
  ...
  /** dxl notifies the client ledger(protocol::LedgerHeader) when closed */
...
typedef GPB_ENUM(ChainTxStatus_TxStatus) {
  ...
  /** notify once failed and set error_code */
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *dxlVersion;
